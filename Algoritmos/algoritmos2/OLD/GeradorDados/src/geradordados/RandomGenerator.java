...
public final class RandomGenerator {
    ...
    public static double pareto(double alpha) {
        return Math.abs(Math.pow(1 - uniform(), -1.0/alpha) - 1.0);
    }
...
//        int N = 30; //Integer.parseInt(10);
//        if (args.length == 2) RandomGenerator.setSeed(Long.parseLong(args[1]));
//        double[] t = { .5, .3, .1, .1 };
//
//        System.out.println("seed = " + RandomGenerator.getSeed());
//        for (int i = 0; i < N; i++) {
//            System.out.println(Math.round((float)pareto(0.15)));
//        }
//    }
