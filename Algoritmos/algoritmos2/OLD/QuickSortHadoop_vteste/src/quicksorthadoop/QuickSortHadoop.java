...
//        saida.close();
     ...
     */
    public static final class Mapeamento implements Mapper<DoubleWritable, Text, DoubleWritable, Text>
    {
         ...
         * @throws IOException
         */
        public void map(DoubleWritable key, Text value, OutputCollector<DoubleWritable, Text> collector, Reporter reporter) throws IOException
        {
            System.out.println("map: " + "k:"+key.toString() +"  v:"+ value.toString());
...
//                collector.collect(new IntPair(valor), valor);
